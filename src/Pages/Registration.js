...
const Registration = () => {
   ...
   let [userData, setUserData] = useState({});
    ...
    function submitForm(e) {
        ...
        axios.post('api/users', userData, {headers: {"Authorisation": "REPLACE_BY_ACTUAL_SESSION"}})
            .then((response) => {
        ...
        <Grid>
            <Paper elevation={3} style={paperStyle}>
                <Grid align='center'>
                    ...
                    <form onSubmit={submitForm} action='/users' method='post'>
                        ...
                        <input onChange={(e) => setUserData({...userData, [e.target.name]: crypto.createHash('sha256').update(e.target.value).digest('hex')})} label='Password' name='password' type='password' placeholder='Enter your password' required/>                    
